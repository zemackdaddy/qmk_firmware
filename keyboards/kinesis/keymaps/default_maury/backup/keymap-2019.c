...
[QWERTY] = LAYOUT(
           ...
           TD(TD_ESC_CAPS),MT(MOD_LALT,KC_A)   ,MT(MOD_LCTL,KC_S)   ,MT(MOD_LGUI,KC_D)   ,MT(MOD_LSFT,KC_F)   ,LT(1,KC_G)   ,
...
[MOUSE] = LAYOUT(
	...
	KC_Y   ,KC_BTN1   ,LT(1,KC_I)   ,KC_BTN2   ,KC_P   ,KC_BSLS,
	KC_H   ,KC_MS_L   ,KC_MS_D   ,KC_MS_U   ,KC_MS_R,KC_QUOT,
