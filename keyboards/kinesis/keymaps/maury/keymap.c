...
[QWERTY] = LAYOUT(
           ...
           KC_CAPS, MT(MOD_LALT,KC_A)   ,MT(MOD_LCTL,KC_S)   ,MT(MOD_LGUI,KC_D)   ,MT(MOD_LSFT,KC_F)   ,KC_G   ,
  ...
  KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,KC_PSCR ,KC_SLCK  , KC_PAUS, KC_FN0, KC_FN0,
	...
	KC_H   ,MT(MOD_RSFT,KC_J)   ,MT(MOD_RGUI,KC_K)   ,MT(MOD_RCTL,KC_L)   ,MT(MOD_RALT,KC_SCLN),  KC_QUOT,
	KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_SLSH,KC_RSFT,
                  KC_UP  ,KC_DOWN,KC_LBRC,KC_RBRC,
           KC_RGUI,  OSM(MOD_RCTL), 
           KC_PGUP,
