...
[MOUSE] = LAYOUT(
		...
		U_NU,								U_NU,							U_NU,								U_NU,							U_NU,									U_NU,
		U_NU,								U_NU,							U_NU,								U_NU,							U_NU,									U_NU,
		U_NU,								LGUI_T(KC_A),			LALT_T(KC_S),				LCTL_T(KC_D),			LSFT_T(KC_F),					U_NU,
		U_NU,								U_NU,							U_NU,								U_NU,							U_NU,									U_NU,
		U_NU,								U_NU,							U_NU,								U_NU,	
		U_NU,								U_NU,
		U_NU,
		...
		U_NU,								U_NU,							U_NU,								U_NU,							U_NU,									U_NU,
		U_NU,								U_NU,							U_NU,								U_NU,							U_NU,									U_NU,
		U_NU,								KC_MS_L,					KC_MS_D,						KC_MS_U,					KC_MS_R, 							U_NU,
		U_NU,								KC_WH_L,					KC_WH_D,						KC_WH_U,					KC_WH_R,							U_NU,
		KC_BTN1,						KC_BTN3,					KC_BTN2,						U_NU,
		U_NU,								U_NU,
		U_NU,
		U_NU,								U_NU,							U_NU
), 
